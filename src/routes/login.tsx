    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
          ...
          <div className="mb-8 flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              <h1 className="text-xl font-semibold text-neutral-900">Chào mừng trở lại</h1>
              <p className="mt-1 text-sm text-neutral-500">Đăng nhập để tiếp tục trò chuyện</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-neutral-300 bg-white pl-10 pr-4 text-sm text-neutral-900 placeholder-neutral-400 outline-none transition-colors focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-neutral-300 bg-white pl-10 pr-10 text-sm text-neutral-900 placeholder-neutral-400 outline-none transition-colors focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
                />
                <button
                  type="button"
                  tabIndex={-1}
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex h-10 w-full items-center justify-center rounded-lg bg-indigo-600 text-sm font-medium text-white transition-colors hover:bg-indigo-700 active:bg-indigo-800 disabled:pointer-events-none disabled:opacity-50"
            >
        ...
        <p className="mt-5 text-center text-xs text-neutral-400">
          Mock: dùng bất kỳ email nào với mật khẩu{" "}
          <code className="rounded bg-neutral-100 px-1.5 py-0.5 text-indigo-600">123456</code>
        </p>
      </div>
    </div>
  );
